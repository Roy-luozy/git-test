...
* Support **almost complete deflate algorithm**:
  ...
  * The compression ratio of this design:
    ...
    * is significantly better than previous open-sourced hardware deflate compressors. See [Evaluation](#eval)
...
- [HDL-deflate](https://github.com/tomtor/HDL-deflate) [3]：An FPGA-based deflate compressor/decompressor
...
- [HT-Deflate-FPGA](https://github.com/UCLA-VAST/HT-Deflate-FPGA) [4]：An FPGA-based multi-core deflate compressor/decompressor
...
The data to be compressed for comparison is [raw.hex]() located in [Arty-example/python](./Arty-example/python) directory, with a size of 512kB.
...
> :warning: The compression ratio of [HT-Deflate-FPGA](https://github.com/UCLA-VAST/HT-Deflate-FPGA) may larger than [HDL-deflate](https://github.com/tomtor/HDL-deflate) , but smaller than [My design](). This conclusion is analyzed based on the algorithm characteristics it supports.
...
* 支持**几乎完整的 deflate 算法** ：
  ...
  * 由于支持了以上功能，本设计的压缩率：
    ...
    * 显著大于其它现有的开源 deflate 压缩器。见 [对比和评估](#eval_cn)
...
- [HDL-deflate](https://github.com/tomtor/HDL-deflate) [3]：一个基于 FPGA 的 deflate 压缩器/解压器。
...
- [HT-Deflate-FPGA](https://github.com/UCLA-VAST/HT-Deflate-FPGA) [4]：一个基于 FPGA 的多核的 deflate 压缩器。
...
用于对比的待压缩数据是 [Arty-example/python](./Arty-example/python) 目录下的 [raw.hex]() ，它的大小是 512kB 。
...
> :warning: [HT-Deflate-FPGA](https://github.com/UCLA-VAST/HT-Deflate-FPGA) 的压缩率应该高于 [HDL-deflate](https://github.com/tomtor/HDL-deflate) ，但低于本设计。这是根据它所支持的算法特性分析出来的。
